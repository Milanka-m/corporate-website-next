...
const PrivacyPolicy: NextPage = () => {
  return (
    <Layout 
      title='Политика конфиденциальности &nbsp;— ООО Ваша компания' 
      desc='Если вы оставляете комментарий на нашем сайте, 
      вы можете включить сохранение вашего имени, адреса email и вебсайта в куки. 
      Это делается для вашего удобства, чтобы не заполнять данные снова при 
      повторном комментировании.'
      ogTitle='Политика конфиденциальности - ООО Ваша компания'>
        <section className={styles.privacyPolicy}>
          <div className={styles.privacyPolicy__container}>
            ...
            <p className={styles.privacyPolicy__text}>
              Наш адрес сайта: https://skillfond.ru.
            </p>
