...
const Portfolio: NextPage<IPortfolioProps> = ({ cards }) => {
	...
	return (
		<Layout
			title='Портфолио &nbsp;— ООО Ваша компания'
			desc='Наше портфолио. Сайт “Karlson”. Сайт “Fine Quality”. Фреш-бар “Fresh Juice”
      		Сайт “Sweet Food”. Сайт “AVVE”. Сайт “Bestclean” и др.'
			ogTitle='Портфолио - ООО Ваша компания'>
